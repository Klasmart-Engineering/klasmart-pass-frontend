...
export function getDetailsByPass(pass: Pass) {
  ...
  if (isPremiumPass(pass.passId)) {
    return [
      ...
      {
        name: "learning_pass_animated_series",
        value: <FormattedMessage id="landing_number_episodes" />,
      },
      {
        name: "learning_pass_premium_songs",
        value: <FormattedMessage id="landing_number_minutes" />,
      },
      { name: "learning_pass_premium_apps", value: 3 },
      {
        name: "learning_pass_ot_purchase",
        value: formatCurrency(pass.currency) + pass.price,
      },
    ];
  }
  return [
...
export function getPassNamePrice(pass: any) {
  var passInfo = {
    ...
    price: formatCurrency(pass.currency) + pass.price,
  };
