...
// Sentry.init({
//   dsn:
//     "https://06373f63bf3749a5a70a73d31194b193@o412774.ingest.sentry.io/5494173",
...
function ClientSide() {
  ...
  const testing =
    (params.test !== undefined) !== (window.location.hostname === "localhost");

  const languageCode = useSelector(
    (state: RootState) => state.account.locale || ""
  );
