const messages: Record<string, string> = {
    ...
    "emailOrPhone.label": "Email / Phone Number",
    ...
    landing_select_header: "Choose the <b>KidsLoop Learning Pass</b> that's right for you!",
    landing_select_header_single: "Unlock <b>all learning apps</b> and <b>300+ ESL lessons</b> today!",
    landing_select_subheader: "Your pass will be valid for one (1) year.",
    landing_tooltip_label: "Have a Learning Pass Ticket ID?",
    landing_tooltip_text: "An event ticket is a ticket ID you might have received through social media.",
    ...
    log_into_account: "Login to your  <b>KidsLoop Account.</b>",
    login: "Login",
    login_button: "LOGIN",
    ...
    my_account_product_title: "KidsLoop Application",
    ...
    payment_prompt_have_standard_pass: "It looks like you already have the <b>Learning Pass</b>",
    payment_prompt_upgrade: "Would you like to upgrade to the <b>KidsLoop Learning Pass Premium</b>",
    payment_thankyou: "Thank you for your purchase",
    payment_thankyou_heading: "You do not need to purchase another pass at this time.",
    ...
    thank_you_intro1: "You are now ready to begin learning English with KidsLoop! To use your pass, log in to the KidsLoop ESL™ application.",
    thank_you_intro2: "KidsLoop Learning Applications can also be individually downloaded and accessed with the same login credentials.",
    thank_you_promo1: "As a token of our appreciation, please accept this holiday coupon code for $20 off your next KidsLoop Gift Toys Package purchase. Enter the code <b>MerryBadaChristmas</b> when you check out.",
