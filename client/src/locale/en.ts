const messages: Record<string, string> = {
  ...
  intro_subheader:
    "Use your email or mobile phone and create a password to access your Kids' Apps on any device at any time.",
  landing_event_ticket_redeem_btn: "Redeem Event Ticket",
  landing_event_ticket_redeem_here_btn: "Redeem Here",
  landing_number_episodes: "52 episodes ",
  landing_number_minutes: "5,000+ minutes ",
  landing_select_header:
    "Choose the <b>Badanamu Learning Pass</b> that's right for you!",
  landing_select_header_single:
    "Unlock <b>all learning apps</b> and <b>300+ ESL lessons</b> today!",
  landing_select_subheader: "Your pass will be valid for one (1) year.",
  landing_tooltip_label: "Have a Learning Pass Ticket ID?",
  ...
  learning_pass_continue_btn: "Continue with the Learning Pass",
  ...
  learning_pass_premium_apps: "Prime apps",
  ...
  payment_accept_terms:
    "I agree to Calm Island's Terms of Service and Return Policy",
  payment_button: "Pay",
  ...
  payment_no_upgrade_btn: "No, take me to my account >",
  payment_pay_option_header: "How do you want to pay?",
  payment_prompt_have_standard_pass:
    "It looks like you already have the <b>Learning Pass</b>",
  payment_prompt_upgrade:
    "Would you like to upgrade to the <b>Badanamu Learning Pass Premium</b>",
  payment_thankyou: "Thank you for your purchase",
  payment_thankyou_heading:
    "You do not need to purchase another pass at this time.",
  payment_view_returns: "View our Return Policy",
  payment_view_terms: "View our Terms of Service",
  payment_yes_upgrade_btn: "Yes, I would like to upgrade.",
  sign_up: "Sign Up",
  ...
  sign_up_error_PASSWORD_LOWERCASE_MISSING:
    "Your password must contain an lowercase letter",
  ...
  thank_you_intro1:
    "You are now ready to begin learning English with Badanamu! To use your pass, log in to the Badanamu ESL™ application.",
  thank_you_intro2:
    "Badanamu Learning Applications can also be individually downloaded and accessed with the same login credentials.",
  thank_you_promo1:
    "As a token of our appreciation, please accept this holiday coupon code for $20 off your next Badanamu Gift Toys Package purchase. Enter the code <b>MerryBadaChristmas</b> when you check out.",
  ...
  verify_email_directions:
    "Enter the verification code or click the link sent to your email.",
