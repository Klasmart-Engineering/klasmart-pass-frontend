...
const errorCodeToMessageID = {
  ...
  [RestAPIErrorType.PASSWORD_NUMBER_MISSING]:
    "sign_up_error_PASSWORD_NUMBER_MISSING",
  [RestAPIErrorType.PASSWORD_UPPERCASE_MISSING]:
    "sign_up_error_PASSWORD_UPPERCASE_MISSING",
  [RestAPIErrorType.PASSWORD_LOWERCASE_MISSING]:
    "sign_up_error_PASSWORD_LOWERCASE_MISSING",

  // Verification
  [RestAPIErrorType.INVALID_VERIFICATION_CODE]:
