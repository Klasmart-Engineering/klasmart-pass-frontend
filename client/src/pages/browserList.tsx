    ...
    <Card>
      <CardContent className={classes.card}>
        ...
        <Typography color="textSecondary">
          We apologize for any inconvenience. We recommend using this site with
        ...
        <Grid container spacing={4} style={{ padding: "16px 0" }}>
          ...
          <Grid item xs={4} style={{ width: "33%", display: "table" }}>
            ...
            <a
              ...
              className={classes.textLogo}
            >
              <Typography variant="caption">Opera</Typography>
            </a>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={4} style={{ padding: "16px 0" }}>
          <Grid item xs={4} style={{ width: "33%", display: "table" }}>
            ...
            <a
              ...
              className={classes.textLogo}
            >
              <Typography variant="caption">Microsoft Edge</Typography>
            </a>
          </Grid>
